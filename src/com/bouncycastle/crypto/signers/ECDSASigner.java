package com.bouncycastle.crypto.signers;

import com.bouncycastle.crypto.CipherParameters;
import com.bouncycastle.crypto.DSA;
import com.bouncycastle.crypto.params.ECKeyParameters;
...
import com.bouncycastle.math.ec.ECAlgorithms;
        ...
        byte[] message)
    {
        ...
        do // generate s
        {
            ...
            do // generate r
            {
                do
                {
                    // make a BigInteger from bytes to ensure that Andriod and 'classic' java make the same BigIntegers  
